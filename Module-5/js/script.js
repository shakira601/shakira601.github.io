...
(function (global) {
  ...
  document.addEventListener("DOMContentLoaded", function (event) {
    // On first load, show the home view
    ...
    $ajaxUtils.sendGetRequest(
      allCategoriesUrl,
      function (categories) {
        // Call the buildAndShowHomeHTML function with retrieved categories
  ...
  // Builds HTML for the home page based on the categories array
  ...
  function chooseRandomCategory(categories) {
    ...
    // Return the category object with that randomArrayIndex
  ...
  function buildAndShowCategoriesHTML(categories) {
    // Load the title snippet of the categories page
    $ajaxUtils.sendGetRequest(
      categoriesTitleHtml,
      function (categoriesTitleHtml) {
        ...
        $ajaxUtils.sendGetRequest(
          ...
          function (categoryHtml) {
            // Switch CSS class active to the menu button
            switchMenuToActive();
  ...
  function buildAndShowMenuItemsHTML(categoryMenuItems) {
    // Load the title snippet of the menu items page
    $ajaxUtils.sendGetRequest(
      menuItemsTitleHtml,
      function (menuItemsTitleHtml) {
        // Retrieve a single menu item snippet
        $ajaxUtils.sendGetRequest(
          menuItemHtml,
  ...
  // Appends the portion name in parens if it exists
